...
{ENTER(ZEND_DECLARE_INHERITED_CLASS_DELAYED_HANDLER)
...
{ENTER(zend_accel_override_file_functions)
...
{NOENTER(MSHUTDOWN-zend_accelerator)
 	(void)type; /* keep the compiler happy */
